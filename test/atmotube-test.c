...
static void
set_plugin_path (const char *path)
{
...
void
test_handle_notification (enum CHARACTER_ID id, uint8_t * data,
			  size_t data_length)
{
...
END_TEST static Atmotube_Device *deviceStore = NULL;

static void *
dummy1 (int num_devices)
{
  deviceStore =
    (Atmotube_Device *) malloc (num_devices * sizeof (Atmotube_Device));
  return deviceStore;
}
...
static void *
dummy4 (int num_devices)
{
  deviceStore2 =
    (StructWithOffset *) malloc (num_devices * sizeof (StructWithOffset));
...
END_TEST static void *p1 = (void *) 0x1;
static void *p2 = (void *) 0x2;

void
callback_ulong (unsigned long ts, unsigned long value, void *data_ptr)
{
...
void
callback_float (unsigned long ts, float value, void *data_ptr)
{
...
START_TEST (test_interval)
{
  ...
  interval_add_ulong_callback (device_id, TEST1, INTERVAL_ULONG,
			       callback_ulong, p1);
  interval_add_float_callback (device_id, TEST2, INTERVAL_FLOAT,
			       callback_float, p2);
  interval_add_ulong_callback (device_id, TEST3, INTERVAL_ULONG,
			       callback_ulong, p1);
...
END_TEST static void *device_ptr[2] = { (void *) 0x1, (void *) 0x2 };

static int called_dev0 = 0;
static int called_dev1 = 0;

static void
multi_callback_ulong_dev0 (unsigned long ts, unsigned long value,
			   void *data_ptr)
{
...
static void
multi_callback_float_dev0 (unsigned long ts, float value, void *data_ptr)
{
...
static void
multi_callback_ulong_dev1 (unsigned long ts, unsigned long value,
			   void *data_ptr)
{
...
static void
multi_callback_float_dev1 (unsigned long ts, float value, void *data_ptr)
{
...
START_TEST (test_multi_interval)
{
  ...
  interval_add_ulong_callback (device_id, TEST1, INTERVAL_ULONG,
			       multi_callback_ulong_dev0, device_ptr[0]);
  interval_add_float_callback (device_id, TEST2, INTERVAL_FLOAT,
			       multi_callback_float_dev0, device_ptr[0]);
  interval_add_ulong_callback (device_id, TEST3, INTERVAL_ULONG,
			       multi_callback_ulong_dev0, device_ptr[0]);
  ...
  interval_add_ulong_callback (device_id, TEST1, INTERVAL_ULONG,
			       multi_callback_ulong_dev1, device_ptr[1]);
  interval_add_float_callback (device_id, TEST2, INTERVAL_FLOAT,
			       multi_callback_float_dev1, device_ptr[1]);
  interval_add_ulong_callback (device_id, TEST3, INTERVAL_ULONG,
			       multi_callback_ulong_dev1, device_ptr[1]);
...
END_TEST static StructWithOffset *deviceStore3 = NULL;

static void *
dummy7 (int num_devices)
{
  deviceStore3 =
    (StructWithOffset *) malloc (num_devices * sizeof (StructWithOffset));
